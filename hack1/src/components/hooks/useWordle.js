...
const useWordle = (solution) => {
    ...
    const [guesses, setGuesses] = useState([[{char:'c', color:'grey'},{char:'o', color:'grey'},{char:'d', color:'grey'},{char:'e', color:'yellow'},{char:'s', color:'grey'}],[],[],[],[],[]]);          // An array whose length is 6. (Ex: [[{char:'c', color:'grey'},{char:'o', color:'grey'},{char:'d', color:'grey'},{char:'e', color:'yellow'},{char:'s', color:'grey'}],[],[],[],[],[]])
    ...
    const handleEnter = () => {
        ...
        const curGuessSet = curGuess.split('');
        for (let i = 0; i < curGuessSet.length; ++i) {
            if (curGuessSet[i] === solutionSet[i]){
